-- ─────────────────────────────────────────────────────────────────────────────
-- Migration 0008 — Safe numeric aggregation
-- Replaces aggregate_dataset so dirty nonnumeric values are ignored instead of
-- crashing SUM/AVG/MIN/MAX or numeric filters.
-- ─────────────────────────────────────────────────────────────────────────────
...
grant execute on function aggregate_dataset(uuid, jsonb, jsonb, jsonb, jsonb, text) to service_role;
